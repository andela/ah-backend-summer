...
from authors.apps.authentication.tests.test_data.login_data import (
    valid_login_data, )
from authors.apps.authentication.tests.test_data.update_data import (
    update_email, )
...
class UpdateTest(BaseTest):
    ...
    def test_user_can_successfully_update_email(self):
        ...
        response = self.client.patch(
            self.url_update, data=update_email, format='json')
    ...
    def test_user_can_retrieve_account_information(self):
        ...
        resp = self.client.post(
            self.url_login, data=valid_login_data, format='json')
