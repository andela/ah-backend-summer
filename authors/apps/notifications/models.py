...
class Notification(models.Model):
    ...
    def queue_notification_emails(self):
        """
        Helper method for doing the necessary task of queueing the send email
        tasks
        We could probably have done something fancy like doing this in a
        post_save, but in this case being explicit is good, and this also
        allows us to retry specific emails that fail to be sent
        This does not send the emails immediately though, it merely queues them
        """
